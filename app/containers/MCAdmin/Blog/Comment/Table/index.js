    ...
    this.props.header.forEach((value) => {
      ...
      if (value.Name !== 'Hide') {
        headers.push(<th // eslint-disable-line
          key={value.Label}
          id={value.Name}
          style={{ paddingLeft, paddingRight, width: `${columnPercentage}%` }}
          ...
          <div className={styles.downloads}>
            <button
              ...
              onClick={() => {
                ...
                const data = (this.state.filter.length > 0) ? tableFunctions.getDownloadData(this.props.header,
                    this.props.downloadBody, this.state.searchedsortedItems) :
                    tableFunctions.getDownloadData(this.props.header, this.props.downloadBody, this.state.allItems);
